    ...
    <div className="min-h-screen bg-background text-white overflow-hidden relative selection:bg-neon-purple selection:text-white font-sans">
        ...
        <div className="md:hidden fixed inset-0 bg-[#0a0a0b]/98 backdrop-blur-2xl z-[100] flex flex-col pt-6 px-6 pb-8 animate-in fade-in zoom-in-95 duration-200">
          ...
          <div className="mt-auto pt-12">
            <Link 
              ...
              target="_blank"
              onClick={() => setIsMobileMenuOpen(false)}
              className="flex items-center justify-center gap-2 w-full py-5 rounded-full bg-gradient-to-r from-[#25D366] to-[#128C7E] text-xl font-bold text-white text-center shadow-[0_0_30px_rgba(37,211,102,0.4)] animate-pulse"
            >
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 p-4 bg-[#0a0a0b]/80 backdrop-blur-xl border-t border-white/10 z-40 pb-safe">
        <Link 
          href="https://wa.me/51924464410?text=Hola,%20quiero%20conocer%20el%20sistema%20para%20abogados%20penalistas" 
          target="_blank"
          className="flex items-center justify-center gap-2 w-full py-4 rounded-xl bg-gradient-to-r from-[#25D366] to-[#128C7E] text-lg font-bold text-white text-center shadow-[0_0_20px_rgba(37,211,102,0.3)] animate-pulse"
        >
