...
- [x] Integrated Mercado Pago for automatic recurring SaaS subscriptions (Preapproval API) and removed Izipay (2026-07-14)
- [x] Instalado Pixel de Facebook en la layout de Next.js `2026-07-14`
- [x] Implement AI Goals (Agendar/Cobrar) with async webhook injection to force payments prior to booking.
- [x] Implemented Mercado Pago 7-day free trial on the backend and checkout UI.
- [x] Implemented Dual Magic Forms (public quiz UI and embedded iframe UI) with a Share section.
- [x] Integrated Google Ads Offline Conversions triggered automatically by Magic Form captures containing gclid.
